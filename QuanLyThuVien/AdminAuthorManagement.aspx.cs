...
namespace QuanLyThuVien
{
    public partial class AdminAuthorManagement : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Mã tác giả đã tồn tại. Bạn không thể thêm tác giả khác có cùng mã tác giả');</script>");
            }
            else
            {
                addNewAuthor();
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Tác giả không tồn tại');</script>");
            }
        }
        // delete button click
        ...
        void getAuthorByID()
        {
            try
            {
                ...
                {
                    Response.Write("<script>alert('Mã tác giả không hợp lệ');</script>");
                }
