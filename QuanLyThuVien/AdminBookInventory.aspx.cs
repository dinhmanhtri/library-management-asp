...
namespace QuanLyThuVien
{
    public partial class AdminBookInventory : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Book Already Exists, try some other Mã sách');</script>");
            }
            else
            {
                addNewBook();
        ...
        void deleteBookByID()
        {
            ...
            {
                Response.Write("<script>alert('Invalid Tên tài khoản');</script>");
            }
        }
        ...
        void updateBookByID()
        {
            ...
            {
                Response.Write("<script>alert('Invalid Mã sách');</script>");
            }
        }
