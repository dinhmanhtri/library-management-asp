<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ViewBooks.aspx.cs" Inherits="QuanLyThuVien.ViewBooks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="row">
            ...
            <center>
                <a href="home.as"><< Quay lại trang chủ</a><span class="clearfix"></span>
                <br />
                <center>
        </div>
    </div>
